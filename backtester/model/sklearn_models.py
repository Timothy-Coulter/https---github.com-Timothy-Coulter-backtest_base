...
class SklearnModel(BaseModel):
    ...
    def predict(self, features: pd.DataFrame) -> np.ndarray:
        ...
        return self.adapter.predict(self._model, features)
    ...
    def _calculate_metrics(self, target: pd.Series, predictions: np.ndarray) -> dict[str, float]:
    ...
    def get_feature_importance(self) -> np.ndarray | None:
        ...
        return self.adapter.get_feature_importance(self._model)
