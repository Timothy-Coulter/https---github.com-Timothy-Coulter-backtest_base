...
class Order:
    ...
    def __repr__(self) -> str:
        ...
        return (f"Order({order_id}, {self.symbol}, {self.side.value}, "
...
class OrderManager:
    ...
    def update_order_status(self, order_id: str, filled_quantity: float,
                           fill_price: float, commission: float = 0.0) -> None:
