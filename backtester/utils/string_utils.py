...
class StringUtils:
    ...
    def format_currency(self, amount: float, symbol: str = "$", decimal: str = ".", 
                       thousands: str = ",", locale_code: str = "en_US") -> str:
    ...
    def format_number(self, number: Union[int, float], decimals: int = 0) -> str:
        """Format number with thousands separator.
