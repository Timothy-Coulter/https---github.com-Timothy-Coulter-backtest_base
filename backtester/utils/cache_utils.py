...
class CacheUtils:
    ...
    def __init__(self, memory_cache: bool = True, cache_dir: Optional[str] = None, 
    ...
    def get(self, key: str, force_check: bool = False) -> Optional[Any]:
    ...
    def _cleanup_memory_cache(self) -> None:
        ...
        cache_items = [
            (key, self._memory_cache_times.get(key, 0)) 
