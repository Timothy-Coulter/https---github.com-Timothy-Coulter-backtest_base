...
class PerformanceAnalyzer:
    ...
    def __init__(self, risk_free_rate: float = 0.02, logger: Optional[logging.Logger] = None) -> None:
    ...
    def calculate_sortino_ratio(self, returns: pd.Series, periods_per_year: int = 252) -> float:
        ...
        return excess_return / downside_deviation_annualized
    ...
    def calculate_alpha(self, strategy_returns: pd.Series, benchmark_returns: pd.Series, 
        ...
        return strategy_annual_return - (self.risk_free_rate + beta * (benchmark_annual_return - self.risk_free_rate))
    ...
    def comprehensive_analysis(self, portfolio_values: pd.Series, 
        ...
        if benchmark_values is not None:
            ...
            information_ratio = self.calculate_information_ratio(aligned_portfolio.dropna(), aligned_benchmark.dropna())
    ...
    def generate_report(self, analysis_results: Dict[str, Any]) -> str:
        ...
        if 'benchmark_total_return' in analysis_results:
            ...
            report.append(f"Benchmark Return:       {analysis_results['benchmark_total_return']:.2%}")
...
class PerformanceCalculator:
    ...
    def calculate_annualized_return(self, initial_value: float, final_value: float, periods: float) -> float:
        """Calculate annualized return."""
    ...
    def calculate_win_rate(self, trades_pnl: pd.Series) -> float:
        ...
        if len(trades_pnl) == 0:
            return 0.0
        return (trades_pnl > 0).sum() / len(trades_pnl)
    ...
    def calculate_alpha(self, asset_returns: pd.Series, benchmark_returns: pd.Series, risk_free_rate: float) -> float:
        """Calculate alpha."""
        ...
        return asset_return - (risk_free_rate + beta * (benchmark_return - risk_free_rate))
...
class DrawdownAnalyzer:
    ...
    def find_drawdown_periods(self, drawdowns: pd.Series) -> list:
