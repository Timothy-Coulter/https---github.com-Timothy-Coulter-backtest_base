...
class TestBacktestConfig:
    ...
    def test_validation_invalid_splits(self):
    ...
    def test_validation_invalid_risk_params(self):
...
class TestStopLossConfig:
    ...
    def test_price_based_stop_loss(self):
...
class TestTakeProfitConfig:
    ...
    def test_price_based_take_profit(self):
...
class TestRiskControlConfig:
    ...
    def test_validation_valid_risk_config(self):
